...
The script 2_6_align_and_trim.py, is prepared to align the already downloaded sequences using MAFFT and then trim the sequences considering them as codons. With the "relaxed" parameters of having half of the sequences with gaps or ambiguities. This same script is used in step 6 as well.
